  ...
  const [src1,setSrc1]=useState("https://imgs.search.brave.com/mi-zvLzHi8N0-s_eGNrU-g5QE4sq30M0inIQ5dMJvac/rs:fit:500:0:0/g:ce/aHR0cHM6Ly91cGxv/YWQud2lraW1lZGlh/Lm9yZy93aWtpcGVk/aWEvY29tbW9ucy8x/LzE4L0ZpdmUtcG9p/bnRlZF9zdGFyLnN2/Zw.svg");
    ...
    function starFn1(){
      ...
      axios.post('/wish/insert', {
        imgsrc : "https://www.lalithaajewellery.com/assets/img/silver/1.webp",
        item : "Sliver",
        itemid:"S1",
        username:""
      });
    ...
    function starFn2(){
      ...
      cnt2++;
      axios.post('/wish/insert', {
        imgsrc : "https://www.lalithaajewellery.com/assets/img/silver/3.webp",
        item : "Sliver",
        itemid:"S2",
        username:user
      });
    ...
    function starFn3(){
      ...
      cnt3++
      axios.post('/wish/insert', {
        imgsrc : "https://www.lalithaajewellery.com/assets/img/silver/4.webp",
        item : "Sliver",
        itemid:"S3",
        username:user
      });
    ...
    function starFn4(){
      ...
      cnt4++
      axios.post('/wish/insert', {
        imgsrc : "https://www.lalithaajewellery.com/assets/img/silver/2.webp",
        item : "Sliver",
        itemid:"S4",
        username:user
      });
    ...
    function starFn5(){
      ...
      cnt5++
      axios.post('/wish/insert', {
        imgsrc : "https://www.lalithaajewellery.com/assets/img/silver/7.webp",
        item : "Sliver",
        itemid:"S5",
        username:user
      });
    ...
    function starFn6(){
      ...
      cnt6++
      axios.post('/wish/insert', {
        imgsrc : "https://www.lalithaajewellery.com/assets/img/silver/5.webp",
        item : "Sliver",
        itemid:"S6",
        username:user
      });
    ...
    function starFn7(){
      ...
      cnt7++
      axios.post('/wish/insert', {
        imgsrc : "https://www.lalithaajewellery.com/assets/img/silver/8.webp",
        item : "Sliver",
        itemid:"S7",
        username:user
      });
    ...
    function starFn8(){
      ...
      cnt8++
      axios.post('/wish/insert', {
        imgsrc : "https://www.lalithaajewellery.com/assets/img/silver/9.webp",
        item : "Sliver",
        itemid:"S8",
        username:user
      });
    ...
    function starFn9(){
      ...
      cnt9++
      axios.post('/wish/insert', {
        imgsrc : "https://www.lalithaajewellery.com/assets/img/silver/12.webp",
        item : "Sliver",
        itemid:"S9",
        username:user
      });
    ...
    function baropen(imagesrc,weightitem,totalbill,id){
      ...
      const itemtype = "Sliver";
      const itemid=id;
      const itemname="Sliver"
...
<main style={{width:"100%",height:"550px", position:"absolute",top:"20px", filter:`blur(${blur})`}}>
  <div  className="orn-img"><img src="https://www.lalithaajewellery.com/assets/img/silver/1.webp" alt=""  style={{width: "300px",height: "300px",  borderRadius: "20px"}} id="img1" />
  <img src={src1} className="svg"alt="" onClick={starFn1} id="star1"/></div>
  <div className="orn-img"><img src="https://www.lalithaajewellery.com/assets/img/silver/3.webp" alt="" style={{width: "300px",height: "300px",  borderRadius: "20px"}} id="img2" /> <img src={src2} className="svg"alt=""  oonClick={starFn2} id="star2"/></div>
  <div className="orn-img"><img src=" https://www.lalithaajewellery.com/assets/img/silver/4.webp" alt="" style={{width: "300px",height: "300px",  borderRadius: "20px"}} id="img3" /> <img src={src3} className="svg"alt="" onClick={starFn3} id="star3"/></div>
  <div className="orn-txt">
    Rs:<span id="cost1" className="orn-cost">2960</span>/-<br/>
    <span className="cal" id="vd1" onClick={()=>baropen("https://www.lalithaajewellery.com/assets/img/silver/1.webp","32.8","2960","S1")}>View Details</span>
  </div>
  <div className="orn-txt">
    Rs:<span id="cost2"  className="orn-cost">2615</span>/-<br/>
    <span  className="cal" id="vd2"  onClick={()=>baropen("https://www.lalithaajewellery.com/assets/img/silver/3.webp","28.2","2615","S2")}>View Details</span>
  </div>
  <div className="orn-txt">
    Rs:<span id="cost3"  className="orn-cost">11683</span>/-<br/>
    <span  className="cal" id="vd3" onClick={()=>baropen("https://www.lalithaajewellery.com/assets/img/silver/4.webp","149.1","11683","S3")}>View Details</span>
  </div>
  <div className="orn-img"><img src="https://www.lalithaajewellery.com/assets/img/silver/2.webp" alt=""  style={{width: "300px",height: "300px",  borderRadius: "20px"}} id="img4"/> <img src={src4} className="svg"alt="" onClick={starFn4} id="star4"/></div>
  <div className="orn-img"><img src="https://www.lalithaajewellery.com/assets/img/silver/7.webp" alt=""   style={{width: "300px",height: "300px",  borderRadius: "20px"}}  id="img5"/> <img src={src5} className="svg"alt="" onClick={starFn5} id="star5"/></div>
  <div className="orn-img"><img src="https://www.lalithaajewellery.com/assets/img/silver/5.webp" alt=""  style={{width: "300px",height: "300px",  borderRadius: "20px"}} id="img6"/> <img src={src6} className="svg"alt="" onClick={starFn6} id="star6"/></div>
  <div className="orn-txt">
    Rs:<span id="cost4" className="orn-cost">4880</span>/- <br/>
    <span  className="cal" id="vd4" onClick={()=>baropen("https://www.lalithaajewellery.com/assets/img/silver/2.webp","58.4","4880","S4")}>View Details</span>
  </div>
  <div className="orn-txt" >
    Rs:<span id="cost5"  className="orn-cost">3470</span>/- <br/>
    <span  className="cal" id="vd5" oonClick={()=>baropen("https://www.lalithaajewellery.com/assets/img/silver/7.webp","39.6","3470","S5")}>View Details</span>
  </div>
  <div className="orn-txt">
    Rs:<span id="cost6" className="orn-cost">16865</span>/-  <br/>
    <span  className="cal" id="vd6" onClick={()=>baropen("https://www.lalithaajewellery.com/assets/img/silver/5.webp","218.2","16865","S6")}>View Details </span>
  </div>
  <div className="orn-img"><img src="https://www.lalithaajewellery.com/assets/img/silver/8.webp" alt=""  style={{width: "300px",height: "300px",  borderRadius: "20px"}} id="img7"/> <img src={src7} className="svg"alt="" onClick={starFn7} id="star7"/></div>
  <div className="orn-img"><img src="https://www.lalithaajewellery.com/assets/img/silver/9.webp" alt=""  style={{width: "300px",height: "300px",  borderRadius: "20px"}}  id="img8"/> <img src={src8}className="svg"alt="" onClick={starFn8}id="star8"/></div>
  <div className="orn-img"><img src="https://www.lalithaajewellery.com/assets/img/silver/12.webp" alt="" style={{width: "300px",height: "300px",  borderRadius: "20px"}} id="img9"/> <img src={src9}className="svg"alt="" onClick={starFn9}id="star9"/></div>
  <div className="orn-txt">
    Rs:<span id="cost7" className="orn-cost">8998</span>/-  <br/>
    <span  className="cal" id="vd7" onClick={()=>baropen("https://www.lalithaajewellery.com/assets/img/silver/8.webp","113.3","8998","S7")}>View Details</span>
  </div>
  <div className="orn-txt" >
    Rs:<span id="cost8"  className="orn-cost">22183</span>/-  <br/>
    <span  className="cal" id="vd8" onClick={()=>baropen("https://www.lalithaajewellery.com/assets/img/silver/9.webp","289.1","22183","S8")}>View Details</span>
  </div>
  <div className="orn-txt">
    Rs:<span id="cost9"  className="orn-cost">13528</span>/-           <br/>
    <span  className="cal" id="vd9" onClick={()=>baropen("https://www.lalithaajewellery.com/assets/img/silver/5.webp","173.7","13527","S9")}>View Details</span>
  </div>
</main>
    </div>
  )
