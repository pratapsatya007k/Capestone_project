...
const Necklace = () => {
  ...
  function wrongsearch(){
    ...
    function starFn1(weight,total){
      ...
      axios.post('/wish/insert', {
        imgsrc : "https://www.lalithaajewellery.com/assets/img/necklace/7.webp",
    ...
    function starFn2(weight,total){
      ...
      cnt2++;
      axios.post('/wish/insert', {
        imgsrc : "https://www.lalithaajewellery.com/assets/img/necklace/6.webp",
        itemName : "Gold Necklace",
        itemid:"N2",
        username:user,
        itemType:"Gold",
    ...
    function starFn3(weight,total){
      ...
      cnt3++
      axios.post('/wish/insert', {
        imgsrc : "https://www.lalithaajewellery.com/assets/img/necklace/11.webp",
        itemName : "Gold Necklace",
        itemid:"N3",
        username:user,
        itemType:"Gold",
    ...
    function starFn4(weight,total){
      ...
      cnt4++
      axios.post('/wish/insert', {
        imgsrc : "https://www.lalithaajewellery.com/assets/img/necklace/8.webpp",
        itemName : "Gold Necklace",
        itemid:"N4",
        username:user,
        itemType:"Gold",
    ...
    function starFn5(weight,total){
      ...
      cnt5++
      axios.post('/wish/insert', {
        imgsrc : "https://www.lalithaajewellery.com/assets/img/necklace/12.webp",
        itemName : "Gold Necklace",
        itemid:"N5",
        username:user,
        itemType:"Gold",
    ...
    function starFn6(weight,total){
      ...
      cnt6++
      axios.post('/wish/insert', {
        imgsrc : "https://www.lalithaajewellery.com/assets/img/necklace/9.webp",
        itemName : "Gold Necklace",
        itemid:"N6",
        username:user,
        itemType:"Gold",
    ...
    function starFn7(weight,total){
      ...
      cnt7++
      axios.post('/wish/insert', {
        imgsrc : "https://www.lalithaajewellery.com/assets/img/necklace/1.webp",
        itemName : "Gold Necklace",
        itemid:"N7",
        username:user,
        itemType:"Gold",
    ...
    function starFn8(weight,total){
      ...
      cnt8++
      axios.post('/wish/insert', {
        imgsrc : "https://www.lalithaajewellery.com/assets/img/necklace/4.webp",
        itemName : "Gold Necklace",
        itemid:"N8",
        username:user,
        itemType:"Gold",
    ...
    function starFn9(weight,total){
      ...
      cnt9++
      axios.post('/wish/insert', {
        imgsrc : "https://www.lalithaajewellery.com/assets/img/necklace/5.webp",
        itemName : "Gold Necklace",
        itemid:"N9",
        username:user,
        itemType:"Gold",
  ...
  <img src={src1} className="svg"alt="" onClick={()=>starFn1("62.6","343066")} id="star1"/></div>
  <div className="orn-img"><img src="https://www.lalithaajewellery.com/assets/img/necklace/6.webp" alt=""  style={{width: "300px",height: "300px",  borderRadius: "20px"}} id="img2" /> <img src={src2} className="svg"alt=""  onClick={()=>starFn2("57.6","313113")}id="star2"/></div>
  <div className="orn-img"><img src=" https://www.lalithaajewellery.com/assets/img/necklace/11.webp" alt=""  style={{width: "300px",height: "300px",  borderRadius: "20px"}} id="img3" /> <img src={src3} className="svg"alt="" onClick={()=>starFn3("55.8","303344")}id="star3"/></div>
  <div className="orn-txt">
    Rs:<span id="cost1" className="orn-cost">343066</span>/-<br/>
    <span className="cal" id="vd1" onClick={()=>baropen("https://www.lalithaajewellery.com/assets/img/necklace/7.webp","62.6","343066","N1")}>View Details</span>
  </div>
  <div className="orn-txt">
    Rs:<span id="cost2"  className="orn-cost">313113</span>/-<br/>
    <span  className="cal" id="vd2"  onClick={()=>baropen("https://www.lalithaajewellery.com/assets/img/necklace/6.webp","57.6","313113","N2")}>View Details</span>
  </div>
  <div className="orn-txt">
    Rs:<span id="cost3"  className="orn-cost">303344</span>/-<br/>
    <span  className="cal" id="vd3" onClick={()=>baropen("https://www.lalithaajewellery.com/assets/img/necklace/11.webp","55.8","303344","N3")}>View Details</span>
  </div>
  <div className="orn-img"><img src="https://www.lalithaajewellery.com/assets/img/necklace/8.webp" alt=""  style={{width: "300px",height: "300px", borderRadius: "20px"}}  id="img4"/> <img src={src4} className="svg"alt="" onClick={()=>starFn4("65.3","354903")} id="star4"/></div>
  <div className="orn-img"><img src="https://www.lalithaajewellery.com/assets/img/necklace/12.webp" alt=""    style={{width: "300px",height: "300px",  borderRadius: "20px"}}  id="img5"/> <img src={src5} className="svg"alt="" onClick={()=>starFn5("51.2","278378")} id="star5"/></div>
  <div className="orn-img"><img src="https://www.lalithaajewellery.com/assets/img/necklace/9.webp" alt="" style={{width: "300px",height: "300px", borderradius: "20px"}}   id="img6"/> <img src={src6} className="svg"alt="" onClick={()=>starFn6("57.2","310942")} id="star6"/></div>
  <div className="orn-txt">
    Rs:<span id="cost4" className="orn-cost">354903</span>/- <br/>
    <span  className="cal" id="vd4" onClick={()=>baropen("https://www.lalithaajewellery.com/assets/img/necklace/8.webp","65.3","354903","N4")}>View Details</span>
  </div>
  <div className="orn-txt" >
    Rs:<span id="cost5"  className="orn-cost">278378</span>/- <br/>
    <span  className="cal" id="vd5" onClick={()=>baropen("https://www.lalithaajewellery.com/assets/img/necklace/12.webp","51.2","278378","N5")}>View Details</span>
  </div>
  <div className="orn-txt">
    Rs:<span id="cost6" className="orn-cost">310942</span>/-  <br/>
    <span  className="cal" id="vd6" onClick={()=>baropen("https://www.lalithaajewellery.com/assets/img/necklace/9.webp","57.2","310942","N6")}>View Details </span>
  </div>
  <div className="orn-img"><img src="https://www.lalithaajewellery.com/assets/img/necklace/1.webp" alt=""  style={{width: "300px",height: "300px",  borderradius: "20px"}}  id="img7"/> <img src={src7} className="svg"alt="" onClick={()=>starFn7("59.8","325053")} id="star7"/></div>
  <div className="orn-img"><img src="https://www.lalithaajewellery.com/assets/img/necklace/4.webp" alt=""   style={{width: "300px",height: "300px",  borderRadius: "20px"}}  id="img8"/> <img src={src8} className="svg"alt=""onClick={()=>starFn8("53","288147")} id="star8"/></div>
  <div className="orn-img"><img src="https://www.lalithaajewellery.com/assets/img/necklace/5.webp" alt="" style={{width: "300px",height: "300px",  borderradius: "20px"}}  id="img9"/> <img src={src9} className="svg"alt=""onClick={()=>starFn9("59.1","321254")} id="star9"/></div>
  <div className="orn-txt">
    Rs:<span id="cost7" className="orn-cost">325053</span>/-  <br/>
    <span  className="cal" id="vd7" onClick={()=>baropen("https://www.lalithaajewellery.com/assets/img/necklace/1.webp","59.8","325053","N7")}>View Details</span>
  </div>
  <div className="orn-txt" >
    Rs:<span id="cost8"  className="orn-cost">288147</span>/-  <br/>
    <span  className="cal" id="vd8" onClick={()=>baropen("https://www.lalithaajewellery.com/assets/img/necklace/4.webp","53","288147","N8")}>View Details</span>
  </div>
  <div className="orn-txt">
    Rs:<span id="cost9"  className="orn-cost">321254</span>/-<br/>
    <span  className="cal" id="vd9" onClick={()=>baropen("https://www.lalithaajewellery.com/assets/img/necklace/5.webp","59.1","321254","N9")}>View Details</span>
  </div>
    </main>
    </div>
  )
